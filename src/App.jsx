...
function App() {
  const { brand, links, about, menuCategories } = KIPLINGS_CONFIG
  ...
  useEffect(() => {
    if (isOrderModalOpen || isMenuModalOpen) {
  ...
  }, [isOrderModalOpen, isMenuModalOpen])
  ...
  return (
    <div className="w-full max-w-[480px] min-h-screen mx-auto bg-cream relative flex flex-col sm:my-6 sm:rounded-md sm:border sm:border-gold-border sm:min-h-[calc(100vh-48px)] shadow-[0_0_40px_rgba(19,21,44,0.08)]">
      ...
      <main className="p-4 sm:p-5 flex flex-col gap-6 pb-10">
        ...
        {/* =======================================================================
            SECTION 3: VISIT US (LOCATION & EXPERIENCE CARD)
            ======================================================================= */}
        <section className="bg-white border border-navy-deep p-5 rounded-[2px] text-center shadow-[0_4px_20px_rgba(19,21,44,0.06)] relative" aria-label="Restaurant Location">
          ...
          <p className="text-[0.86rem] text-navy-surface-light/85 leading-relaxed mb-3">
            {brand.locationFull}
          </p>
        ...
        {/* =======================================================================
            ...
            ======================================================================= */}
        <section className="text-center pt-2" aria-label="Social Channels">
          ...
          <div className="flex justify-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-navy-deep/20 rounded-full font-caps-accent text-xs font-bold tracking-wider text-navy-deep hover:bg-navy-deep hover:text-gold-light hover:border-navy-deep transition-all group"
      ...
      {/* =========================================================================
          INTERACTIVE MODAL 2: MENU QUICK-VIEW
          ========================================================================= */}
      {isMenuModalOpen && (
        <div
          className="fixed inset-0 bg-navy-dark/80 backdrop-blur-sm z-50 flex items-end justify-center transition-opacity"
        ...
        >
          ...
          >
            ...
            <div className="flex justify-between items-start mb-5">
              <div>
                <h3 id="menu-sheet-title" className="font-serif-title text-[1.35rem] text-navy-deep leading-tight">
                  Kiplings Menu
                </h3>
                <p className="text-xs text-navy-surface-light/80 mt-1">
                  Crafted fresh, served fresh every day
                </p>
              </div>
              <button
                type="button"
            ...
            <div className="flex flex-col gap-2.5 mb-5">
              {menuCategories.map((cat, idx) => (
                <div key={idx} className="bg-white border border-gold-primary/35 p-3 rounded-[2px]">
                  <div className="font-serif-title text-[0.98rem] font-semibold text-navy-deep flex justify-between items-center">
                    <span>{cat.name}</span>
                    <span className="text-gold-dark text-xs">◆</span>
                  </div>
                  <p className="text-xs text-navy-surface-light/80 mt-1 leading-snug">
                    {cat.items}
                  </p>
                </div>
              ))}
            ...
            <button
              type="button"
              className="w-full min-h-[50px] bg-navy-deep text-gold-light border-[1.5px] border-gold-primary rounded-[2px] font-caps-accent text-sm font-bold tracking-[0.15em] uppercase hover:bg-navy-surface transition-colors cursor-pointer"
              onClick={() => {
                setIsMenuModalOpen(false)
                setIsOrderModalOpen(true)
              }}
            >
              Order Online / Dine-In Now
            </button>
          </div>
        </div>
      )}
